...
| Nested callable local variable rename | Not applicable | Local variable usages inside the selected callable body, explicit closure captures, and implicit arrow-function captures | Not applicable | Not supported | Same-callable parameters and local variables | Conservative scoped rename only; shadowed nested callable parameters are skipped |
