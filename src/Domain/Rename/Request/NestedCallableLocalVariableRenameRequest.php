...
/**
 * Describes a local variable rename inside a nested closure or arrow function.
 */
final readonly class NestedCallableLocalVariableRenameRequest implements RenameRequestInterface
{
    /**
     * Constructor.
     *
    ...
    public function __construct(
        ...
        RenameInputValidator::guardShortIdentifier($variableName, 'variableName');
